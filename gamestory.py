...
# lists
selection_list = ["go back to selection", "go back to the selection", "go back to the selection menu", "selection",
                  "selection menu"]
...
dont_move_list = ["dont move", "dont", "dont move please", "don't move"]
throw_something = ["throw something", "throw", "get something"]
vent_list = ["vent", "go to the vent", "go through the vent"]
...
def ventordoor1():
    ...
    if vent_or_door in hit_door_open:
        ...
        time.sleep(1)
        waiting_animated()
        print(teacher + " runs up to you and tries to grab you, but you kick them in the face")
        time.sleep(1)
        waiting_animated()
...
#####story part where user gets to the other side of the door
def out_of_door():
...
def playagain():
    print("Would you like to play again? Or would you like to go back to the selection?")
    playagain2()
...
def playagain2():
    ...
    if play in yes_list or play in play_again_list:
        ...
        quit()
    elif play in go_back_list or play in selection_list:
        import maincentre
